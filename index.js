...
function is31Flavors(array){
  const flavorsAmount = array.length;
...
console.log(addFlavor(originalFlavors, 'Ranbow Sherbert'));
...
function removeFlavorByName(array, falvorName){
  ...
  for(let i = 0; i < newFlavorList.length; i++){
    if(newFlavorList[i] === falvorName){
      newFlavorList.splice(i,1);
    }
  }
   return newFlavorList;
}

console.log(removeFlavorByName(copy(originalFlavors)), 'Chocolate');
